...
{
       0,    81,    81,   110,   110,   113,   114,   120,   121,   121,
     121,   124,   124,   124,   127,   128,   129,   134,   134,   144,
     145,   146,   149,   161,   168,   171,   210,   211,   214,   215,
     216,   220,   252,   255,   256,   259,   260,   261,   262,   263,
     264,   267,   268,   273,   274,   277,   282,   291,   327,   375,
     411,   456,   481,   502,   505,   528,   549,   552,   553,   554,
     555,   556,   559,   566,   572,   580,   581,   582,   583,   586,
     592,   598,   604,   610,   616
};
#endif
...
#line 1511 "y.tab.c" /* yacc.c:1652  */
  ...
  case 5:
#line 113 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A).code = code_concatenate(2,(yyvsp[-2].A).code,(yyvsp[0].A).code); (yyval.A).optimized_code = code_concatenate(2,(yyvsp[-2].A).optimized_code, (yyvsp[0].A).optimized_code);}
#line 1517 "y.tab.c" /* yacc.c:1652  */
    break;

  case 6:
#line 114 "c_ICG.y" /* yacc.c:1652  */
...
#line 1609 "y.tab.c" /* yacc.c:1652  */
  ...
  case 19:
#line 144 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 1615 "y.tab.c" /* yacc.c:1652  */
    break;

  case 20:
#line 145 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A).code = code_concatenate(2,(yyvsp[-1].A).code, (yyvsp[0].A).code); (yyval.A).optimized_code = code_concatenate(2,(yyvsp[-1].A).optimized_code, (yyvsp[0].A).optimized_code);}
#line 1621 "y.tab.c" /* yacc.c:1652  */
    break;

  case 21:
#line 146 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A).code = code_concatenate(2,(yyvsp[-1].A).code, (yyvsp[0].A).code); (yyval.A).optimized_code = code_concatenate(2,(yyvsp[-1].A).optimized_code, (yyvsp[0].A).optimized_code);}
#line 1627 "y.tab.c" /* yacc.c:1652  */
    break;

  case 22:
#line 149 "c_ICG.y" /* yacc.c:1652  */
    {char* lab1 = new_label();
								//printf("in switch\n"); 
								char* lab2 = new_label(); 
								//printf("in switch\n"); 
...
#line 1647 "y.tab.c" /* yacc.c:1652  */
  ...
  case 24:
#line 168 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 1653 "y.tab.c" /* yacc.c:1652  */
    break;

  case 25:
#line 171 "c_ICG.y" /* yacc.c:1652  */
    {char* begin = new_label(); 
															(yyvsp[-5].A).next = begin; 
															...
															//$8.next = new_label();
															(yyvsp[-2].A).next = begin;

															(yyval.A).code = code_concatenate(8,(yyvsp[-5].A).code, code_gen(2,begin,": "),code_gen(4,"if ", (yyvsp[-4].A).code, "goto ", (yyvsp[-4].A).true), 
															code_gen(2,"goto ", (yyvsp[-4].A).false), code_gen(2,(yyvsp[-4].A).true,": "),(yyvsp[0].A).code, code_gen(2,"goto ",begin),code_gen(2,(yyvsp[0].A).next,": \n"));

															if(num_iter)
															{
																//printf("HERE\n");
																(yyval.A).optimized_code = " ";
																(yyval.A).optimized_code = code_concatenate(2,(yyval.A).optimized_code,(yyvsp[-5].A).optimized_code);
...
#line 1707 "y.tab.c" /* yacc.c:1652  */
  ...
  case 28:
#line 214 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 1713 "y.tab.c" /* yacc.c:1652  */
    break;

  case 29:
#line 215 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 1719 "y.tab.c" /* yacc.c:1652  */
    break;

  case 30:
#line 216 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 1725 "y.tab.c" /* yacc.c:1652  */
    break;

  case 31:
#line 220 "c_ICG.y" /* yacc.c:1652  */
...
#line 291 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A).addr = gen_addr((yyvsp[-4].text));  
										...
										if((yyvsp[-2].A).is_dig)
			   							(yyval.A).optimized_code = code_concatenate(2,code_gen(3,(yyval.A).addr," = ",buf),(yyvsp[0].A).optimized_code);
			   							else
...
#line 327 "c_ICG.y" /* yacc.c:1652  */
    {
		  								...
		  								if(ret)
			   							{
			   								if(is_digit((yyvsp[-1].A).addr))
			   								{
			   									...
			   									char buf1[10];
			   									gcvt(val1, 6, buf1);
			   									(yyval.A).code = code_concatenate(2,(yyvsp[-1].A).code,code_gen(3,(yyval.A).addr," = ",buf1));
			   								}
			   								else
										...
										if((yyvsp[-1].A).is_dig)
										{
			   							...
			   							{
			   								(yyval.A).optimized_code = code_concatenate(2,(yyvsp[-1].A).optimized_code,code_gen(3,(yyval.A).addr," = ",(yyvsp[-1].A).addr)); 
			   								//flag1=1;
			   							}
			   							//printf("OC: %s\n",$$.optimized_code);
										...
										if(strcmp(typ,"int")==0)
		   								{
		   									if(is_digit((yyvsp[-2].A).addr))
		   									{
		   										...
		   										char buf1[10];
		   										gcvt(val1, 6, buf1);
		   										(yyval.A).code = code_concatenate(3,(yyvsp[-2].A).code,code_gen(5,typ," ",(yyval.A).addr," = ",buf1),(yyvsp[0].A).code); 
		   									}
		   									else
		   										(yyval.A).code = code_concatenate(3,(yyvsp[-2].A).code,code_gen(5,typ," ",(yyval.A).addr," = ",(yyvsp[-2].A).addr),(yyvsp[0].A).code); 
    ...
    {  (yyval.A).addr = gen_addr((yyvsp[-3].text));  
		   								...
		   								if(strcmp(typ,"int")==0)
		   								{
		   									if(is_digit((yyvsp[-1].A).addr))
		   									{
		   										...
		   										char buf1[10];
		   										gcvt(val1, 6, buf1);
		   										(yyval.A).code = code_concatenate(2,(yyvsp[-1].A).code,code_gen(5,typ," ",(yyval.A).addr," = ",buf1)); 
		   									}
		   									else
		   										(yyval.A).code = code_concatenate(2,(yyvsp[-1].A).code,code_gen(5,typ," ",(yyval.A).addr," = ",(yyvsp[-1].A).addr)); 
...
#line 456 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A).addr = new_temp(); (yyval.A).code = code_concatenate(3,(yyvsp[-2].A).code,(yyvsp[0].A).code,code_gen(5,(yyval.A).addr," = ",(yyvsp[-2].A).addr," + ",(yyvsp[0].A).addr)); 
				...
				if(((yyvsp[-2].A).is_dig) && ((yyvsp[0].A).is_dig))
				{
					...
					char buf[10];
					gcvt(temp, 6, buf);
					(yyval.A).optimized_code = code_concatenate(3,(yyvsp[-2].A).optimized_code,(yyvsp[0].A).optimized_code,code_gen(3,(yyval.A).addr," = ",buf));
					//printf("%s\n",$$.optimized_code);
					(yyval.A).val = temp;
					flag1 &= 1;
				}
...
#line 2096 "y.tab.c" /* yacc.c:1652  */
  ...
  case 53:
#line 502 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 2102 "y.tab.c" /* yacc.c:1652  */
    break;

  case 54:
#line 505 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A).addr = new_temp(); (yyval.A).code = code_concatenate(3,(yyvsp[-2].A).code,(yyvsp[0].A).code,code_gen(5,(yyval.A).addr," = ",(yyvsp[-2].A).addr," * ",(yyvsp[0].A).addr)); 
				if(((yyvsp[-2].A).is_dig) && ((yyvsp[0].A).is_dig))
				{
					(yyval.A).is_dig=1;
...
#line 2162 "y.tab.c" /* yacc.c:1652  */
    break;

  case 57:
#line 552 "c_ICG.y" /* yacc.c:1652  */
...
#line 2174 "y.tab.c" /* yacc.c:1652  */
  ...
  case 59:
#line 554 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)= (yyvsp[-1].A);}
#line 2180 "y.tab.c" /* yacc.c:1652  */
    break;

  case 60:
#line 555 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 2186 "y.tab.c" /* yacc.c:1652  */
    break;

  case 61:
#line 556 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.A)=(yyvsp[0].A);}
#line 2192 "y.tab.c" /* yacc.c:1652  */
    break;

  case 62:
#line 559 "c_ICG.y" /* yacc.c:1652  */
...
#line 2226 "y.tab.c" /* yacc.c:1652  */
  ...
  case 65:
#line 580 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.text)="+";}
#line 2232 "y.tab.c" /* yacc.c:1652  */
    break;

  case 66:
#line 581 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.text)="-";}
#line 2238 "y.tab.c" /* yacc.c:1652  */
    break;

  case 67:
#line 582 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.text)="*";}
#line 2244 "y.tab.c" /* yacc.c:1652  */
    break;

  case 68:
#line 583 "c_ICG.y" /* yacc.c:1652  */
    {(yyval.text)="/";}
#line 2250 "y.tab.c" /* yacc.c:1652  */
    break;

  case 69:
#line 586 "c_ICG.y" /* yacc.c:1652  */
    { (yyval.A).addr = new_temp(); 
